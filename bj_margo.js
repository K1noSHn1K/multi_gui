zavod = "";
var train1 = "dressage", train2 = "endurance", train3 = "galop", sorik_count = 0, sorik2_count = 0, ksk_select = 0, specialisation = "specialisationWestern", amSpecialisation = "western", compName = "reining", compName2 = "", sorik = "", walk1 = "", walk2 = "", spec = "foret", KCK_Select = KCK_ALL, centerLocalisation = "centerLocalisationForet", nav = 0, mol = 360, name_male = "", name_female = "", offersToBeDone = 10, poroda = 38, speed = "norm", shortPause1 = 100, shortPause2 = 120, mediumPause1 = 
400, mediumPause2 = 500, longPause1 = 700, longPause2 = 800, centerCount = 2, centerPosition = 2;
load_settings();
"reserve" == ksk_select && (KCK_Select = KCK_reserve);
"all" == ksk_select && (KCK_Select = KCK_ALL);
...
if (/\/elevage\/chevaux\/cheval\?id=/.test(window.location.href)) {
  ...
  75 < sante && (6 >= chevalAge ? -1 == chevalNom.indexOf(".") ? (ClearLocalStorage(amunitionEquiped), giveHorseName()) : MainProg() : 6 < chevalAge && 16 >= chevalAge ? (localStorage.setItem("sorik_count", 0), localStorage.setItem("sorik2_count", 0), MainProg()) : HorseTraining());
}
"foret" == spec && (centerLocalisation = "centerLocalisationForet");
"montagne" == spec && (centerLocalisation = "centerLocalisationMontagne");
"plage" == spec && (centerLocalisation = "centerLocalisationPlage");
function MainProg() {
  function a() {
  ...
  function c() {
    var a = document.getElementsByClassName("action action-style-4 allaiter action-disabled"), c = document.getElementById("feeding"), d = -1;
    null !== c && (d = c.innerHTML.indexOf("\u0442\u043e\u043b\u0441\u0442"));
    void 0 !== document.getElementsByClassName("tab-action tab-action-select action action-style-4 nourrir-entame")[0] || -1 !== d || void 0 !== a[0] ? (a = getRandomPause(shortPause1, shortPause2), setTimeout(f, a)) : (a = getRandomPause(shortPause1, shortPause2), setTimeout(doEatNorm, a), a += getRandomPause(longPause1, longPause2), setTimeout(b, a));
  }
  function f() {
    if (20 > document.getElementById("energie").innerHTML) {
      ...
      void 0 !== a[0] || void 0 !== b[0] ? (a = getRandomPause(shortPause1, shortPause2), setTimeout(d, a)) : (a = getRandomPause(shortPause1, shortPause2), setTimeout(stroke, a), a += getRandomPause(mediumPause1, mediumPause2), setTimeout(f, a));
    } else {
      a = getRandomPause(shortPause1, shortPause2), setTimeout(d, a);
    }
  }
  function d() {
    ...
    void 0 !== a[0] || void 0 !== b[0] ? (a = getRandomPause(shortPause1, shortPause2), setTimeout(OR, a), a += getRandomPause(longPause1, longPause2), setTimeout(pauseFunc, a), a += getRandomPause(2 * longPause1, 2 * longPause2), setTimeout(reload, a)) : (a = getRandomPause(shortPause1, shortPause2), setTimeout(sleep, a), a += getRandomPause(mediumPause1, mediumPause2), setTimeout(d, a));
  }
  var g = getRandomPause(shortPause1, shortPause2);
  setTimeout(a, g);
}
function HorseTraining() {
  sorik_count = parseInt(localStorage.getItem("sorik_count"), 10);
  sorik2_count = parseInt(localStorage.getItem("sorik2_count"), 10);
  console.log("Sorik Count = " + sorik_count);
  console.log("Sorik2 Count = " + sorik2_count);
  16 < chevalAge && 22 >= chevalAge ? (OatsToGive = 12, Walks(walk1)) : void 0 === document.getElementsByClassName("action action-style-4 competition-barrel action")[0] && void 0 === document.getElementsByClassName("action action-style-4 competition-galop action")[0] && 36 < chevalAge ? EquipAmunition() : 100 > getMyParameterByName(walk1 + "Complet") ? (OatsToGive = HayToGive = 14, Walks(walk1)) : 100 > getMyParameterByName(train1 + "TComplet") ? (localStorage.setItem("sorik_count", 0), OatsToGive = 
  14, Train(train1)) : 100 > getMyParameterByName(train2 + "TComplet") ? (localStorage.setItem("sorik_count", 0), OatsToGive = 12, Train(train2)) : sorik_count < sorik && 120 > chevalAge ? (console.log("\u0421\u043e\u0440\u0435\u0432\u043d\u043e\u0432\u0430\u043d\u0438\u044f"), HayToGive = -1, OatsToGive = 8, 29 < chevalEnergie && 1270 > timeConvert() ? (console.log("-=CompnoVIP=- Energy: " + chevalEnergie + " Time: " + timeConvert()), CompNoVIP()) : (console.log("-=ANOTHER=- Energy: " + chevalEnergie + 
  " Time: " + timeConvert()), setTimeout(carrot, 100), setTimeout(minEnergy, 400), setTimeout(mash(), 700), setTimeout(sleep, 1000), setTimeout(OR, 1100))) : 100 > getMyParameterByName(walk2 + "Complet") && "" != walk2 ? (localStorage.setItem("sorik2_count", 0), OatsToGive = HayToGive = 14, Walks(walk2)) : 100 > getMyParameterByName(train3 + "TComplet") ? (localStorage.setItem("sorik2_count", 0), OatsToGive = 12, Train(train3)) : "" != compName2 && sorik2_count < sorik && 120 > chevalAge ? (console.log("Sorik 2 = " + 
  sorik2_count), 29 < chevalEnergie && 1270 > timeConvert() ? CompNoVIP_Second() : (console.log("-=ANOTHER Comp2=- Energy: " + chevalEnergie + " Time: " + timeConvert()), setTimeout(carrot, 100), setTimeout(minEnergy, 400), setTimeout(mash(), 700), setTimeout(sleep, 1000), setTimeout(OR, 1100))) : 120 > chevalAge ? (HayToGive = 12, OatsToGive = 14, setTimeout(function() {
    MainProg();
...
function GiveSluchki(a) {
  ...
  function d() {
    ...
    void 0 !== a[0] || void 0 !== e[0] ? (a = getRandomPause(shortPause1, shortPause2), setTimeout(g, a)) : (a = getRandomPause(shortPause1, shortPause2), setTimeout(drink, a), a += getRandomPause(mediumPause1, mediumPause2), setTimeout(d, a));
  }
  function g() {
  ...
  function k() {
    ...
    1100 < timeConvert() || void 0 !== a[0] || void 0 !== e[0] ? a = getRandomPause(shortPause1, shortPause2) : (console.log("offers=" + ReadLocalStorage(offers)), console.log("offers=" + ReadLocalStorage(offers)), a = getRandomPause(shortPause1, shortPause2));
    setTimeout(l, a);
  }
  function l() {
    var a = document.getElementsByClassName("action action-style-4 caresser action-disabled"), b = document.getElementsByClassName("action action-style-4 caresser-rainbow action-disabled");
    void 0 !== a[0] || void 0 !== b[0] ? (a = getRandomPause(shortPause1, shortPause2), setTimeout(e, a)) : (a = getRandomPause(shortPause1, shortPause2), setTimeout(stroke, a), a += getRandomPause(mediumPause1, mediumPause2), setTimeout(l, a));
  }
  function e() {
    ...
    void 0 !== a[0] || void 0 !== b[0] ? (a = getRandomPause(shortPause1, shortPause2), setTimeout(m, a)) : (a = getRandomPause(shortPause1, shortPause2), setTimeout(carrot, a), a += getRandomPause(mediumPause1, mediumPause2), setTimeout(e, a));
  }
  function m() {
    ...
    void 0 !== b[0] && (void 0 !== a[0] || void 0 !== e[0]) && parseInt(ReadLocalStorage(offers), 10) >= offersToBeDone ? (ClearLocalStorage(offers), GoToMother()) : void 0 === b[0] || void 0 === a[0] && void 0 === e[0] ? (a = getRandomPause(shortPause1, shortPause2), setTimeout(sleep, a), a += getRandomPause(3 * longPause1, 3 * longPause2), setTimeout(m, a)) : (a = getRandomPause(shortPause1, shortPause2), setTimeout(OR, a), a += getRandomPause(3 * longPause1, 3 * longPause2), setTimeout(pauseFunc, 
    a));
  }
...
function BirthProg() {
  ...
  console.log("\u0423\u0441\u043b\u043e\u0432\u0438\u0435 \u0440\u043e\u0434\u0438\u0442\u044c = " + a);
  a ? document.getElementById("lienVeterinaire").click() : 800 < timeConvert() ? (a = getRandomPause(mediumPause1, mediumPause2), setTimeout(MainProg, a)) : 0 == nav ? "1" == $(".action-style-4.saillir").length && !1 === $(".action-style-4.saillir").hasClass("action-disabled") ? (a = getRandomPause(shortPause1, shortPause2), setTimeout(openReproduction, a)) : (a = getRandomPause(shortPause1, shortPause2), setTimeout(openReproduction, a), a += getRandomPause(mediumPause1, mediumPause2), setTimeout(Train1, 
  a)) : "1" == $(".action-style-4.saillir").length && !1 === $(".action-style-4.saillir").hasClass("action-disabled") ? (a = getRandomPause(shortPause1, shortPause2), setTimeout(openReproduction, a)) : (a = getRandomPause(shortPause1, shortPause2), setTimeout(openReproduction, a), a += getRandomPause(mediumPause1, mediumPause2), setTimeout(MainProg, a));
}
function Train1() {
...
function Walks(a) {
  ...
  function c() {
    ...
    99 < a || void 0 !== e[0] || void 0 !== b[0] ? (a = getRandomPause(shortPause1, shortPause2), setTimeout(f, a)) : (a = getRandomPause(shortPause1, shortPause2), setTimeout(drink, a), a += getRandomPause(mediumPause1, mediumPause2), setTimeout(c, a));
  }
  function f() {
    if (600 < timeConvert()) {
      ...
      e = getRandomPause(shortPause1, shortPause2), setTimeout(function() {
        walk_another(a, 5);
      }, e), e += getRandomPause(mediumPause1, mediumPause2), setTimeout(f, e);
    }
  }
  function d() {
    if (void 0 !== document.getElementsByClassName("action action-style-4 mash action-disabled")[0]) {
      ...
      a = getRandomPause(shortPause1, shortPause2), setTimeout(mash, a), a += getRandomPause(mediumPause1, mediumPause2), setTimeout(d, a);
    }
  }
  function g() {
    var a = document.getElementsByClassName("action action-style-4 boire action-disabled"), e = document.getElementsByClassName("action action-style-4 boire-fontaine action-disabled");
    void 0 !== a[0] || void 0 !== e[0] ? (a = getRandomPause(shortPause1, shortPause2), setTimeout(h, a)) : (a = getRandomPause(shortPause1, shortPause2), setTimeout(drink, a), a += getRandomPause(mediumPause1, mediumPause2), setTimeout(g, a));
  }
  function h() {
  ...
  function k() {
    var e = document.getElementsByClassName("action action-style-4 caresser action-disabled"), b = document.getElementsByClassName("action action-style-4 caresser-rainbow action-disabled"), c = document.getElementsByClassName("action action-style-4 carotte action-disabled"), n = document.getElementsByClassName("action action-style-4 carotte-rainbow action-disabled"), d = document.getElementById("energie").innerHTML;
    void 0 !== e[0] || void 0 !== b[0] || void 0 !== c[0] || void 0 !== n[0] || 10 > d || 1300 < timeConvert() ? (e = getRandomPause(shortPause1, shortPause2), setTimeout(l, e)) : (e = getRandomPause(shortPause1, shortPause2), setTimeout(function() {
      walk(a);
    }, e), e += getRandomPause(mediumPause1, mediumPause2), setTimeout(k, e));
  }
  function l() {
    var a = document.getElementsByClassName("action action-style-4 caresser action-disabled"), b = document.getElementsByClassName("action action-style-4 caresser-rainbow action-disabled");
    void 0 !== a[0] || void 0 !== b[0] ? (a = getRandomPause(shortPause1, shortPause2), setTimeout(e, a)) : (a = getRandomPause(shortPause1, shortPause2), setTimeout(stroke, a), a += getRandomPause(mediumPause1, mediumPause2), setTimeout(l, a));
...
function walk_another(a, b) {
  ...
  switch(a) {
    case "foret":
      ...
      break;
    case "montagne":
      f = document.getElementById("walkmontagneSlider").getElementsByTagName("li"), d = document.getElementById("walkmontagneSlider-sliderHidden"), g = document.getElementById("walk-montagne-submit");
  }
...
function walk(a) {
  ...
  switch(a) {
    case "foret":
      ...
      break;
    case "montagne":
      c = document.getElementById("walkmontagneSlider").getElementsByTagName("li"), f = document.getElementById("walkmontagneSlider-sliderHidden"), d = document.getElementById("walk-montagne-submit");
  }
...
function Train9(a) {
  ...
  function h() {
    ...
    30 > c || void 0 !== e[0] || void 0 !== b[0] || 1300 < timeConvert() ? (c = getRandomPause(shortPause1, shortPause2), setTimeout(k, c)) : (e = getMyParameterByName(a + "TComplet"), 94 > e ? (c = getRandomPause(shortPause1, shortPause2), setTimeout(function() {
      train(a, 20);
    }, c), c += getRandomPause(mediumPause1, mediumPause2), setTimeout(h, c)) : 94 < e && 1300 > timeConvert() && 94 < e && 15 < c ? (c = getRandomPause(shortPause1, shortPause2), setTimeout(function() {
      walk(walk1);
    }, c), c += getRandomPause(longPause1, longPause2), setTimeout(h, c)) : (c = getRandomPause(shortPause1, shortPause2), setTimeout(k, c)));
  }
  function k() {
    var a = document.getElementsByClassName("action action-style-4 caresser action-disabled"), e = document.getElementsByClassName("action action-style-4 caresser-rainbow action-disabled");
    void 0 !== a[0] || void 0 !== e[0] ? (a = getRandomPause(shortPause1, shortPause2), setTimeout(l, a)) : (a = getRandomPause(shortPause1, shortPause2), setTimeout(stroke, a), a += getRandomPause(mediumPause1, mediumPause2), setTimeout(k, a));
  }
  function l() {
    ...
    19 < a || void 0 !== b[0] || void 0 !== c[0] ? (a = getRandomPause(shortPause1, shortPause2), setTimeout(e, a)) : (a = getRandomPause(shortPause1, shortPause2), setTimeout(carrot, a), a += getRandomPause(mediumPause1, mediumPause2), setTimeout(l, a));
  }
  function e() {
    var a = document.getElementsByClassName("action action-style-4 caresser action-disabled"), b = document.getElementsByClassName("action action-style-4 caresser-rainbow action-disabled");
...
function train(a, b) {
  ...
  switch(a) {
    ...
    case "trot":
      ...
      break;
    case "saut":
      d = document.getElementById("trainingSautSlider").getElementsByTagName("li"), g = document.getElementById("trainingSautSlider-sliderHidden"), h = document.getElementById("training-saut-submit");
  }
  for (b <= f ? c = b : b > f && (c = f); 0 <= c; c--) {
    if ("green hiddenNumber disabled" !== d[c].className && "green disabled" !== d[c].className) {
      d[c].className += " selected";
      d[c].click();
      g.value = c;
      d[c].click();
      h.click();
...
function competitionByName(a) {
  localStorage.setItem("sorik_count", parseInt(localStorage.getItem("sorik_count"), 10) + 1);
...
function CompNoVIP() {
  ...
  function b() {
    ...
    void 0 !== a[0] || void 0 !== d[0] ? (a = getRandomPause(shortPause1, shortPause2), setTimeout(c, a)) : (a = getRandomPause(shortPause1, shortPause2), setTimeout(drink, a), a += getRandomPause(mediumPause1, mediumPause2), setTimeout(b, a));
  }
  function c() {
    if (700 > timeConvert()) {
      var a = getRandomPause(shortPause1, shortPause2);
  ...
  function f() {
    var a = document.getElementsByClassName("action action-style-4 allaiter action-disabled");
    void 0 !== document.getElementsByClassName("tab-action tab-action-select action action-style-4 nourrir-entame")[0] || void 0 !== a[0] ? (a = getRandomPause(shortPause1, shortPause2), setTimeout(d, a)) : (a = getRandomPause(shortPause1, shortPause2), setTimeout(openFeeding, a), a += getRandomPause(mediumPause1, mediumPause2), setTimeout(doEatDef, a), a += getRandomPause(longPause1, longPause2), setTimeout(f, a));
  }
  function d() {
    if (1250 > timeConvert()) {
      var a = getRandomPause(shortPause1, shortPause2);
...
function doEatDef() {
  ...
  if (0 !== c + f) {
    ...
    -1 !== b.indexOf("oatsSlider") && (d = document.getElementById("oatsSlider").getElementsByTagName("li"), a = f, d[a].className += " selected", d[a].click(), d = document.getElementById("oatsSlider-sliderHidden"), d.setAttribute("value", a), a = !0);
...
function KCK_reserve() {
  ...
  a += getRandomPause(2700, 3200);
  setTimeout(eqCenterReg3, a);
  a += getRandomPause(3500, 3700);
  setTimeout(eqCenterReg4, a);
}
function eqCenterReg2() {
  console.log("eqCenterReg2");
...
function eqCenterReg3() {
  var a = 0;
  console.log("eqCenterReg3");
  for (var b = document.getElementById("boxContent").getElementsByTagName("tbody")[0].getElementsByTagName("tr"), c = 1; c < b.length; c++) {
    if (localisation = b[c].getElementsByClassName("align-left width-19")[0].getElementsByTagName("a")[0].className, console.log("Conf localisation = " + centerLocalisation + "; Page Localisation = " + localisation), localisation == "centerLocalisation " + centerLocalisation) {
      var f = b[c].getElementsByClassName("align-center")[0].outerHTML, d = f.search("abreuvoir");
      if (0 < d && (f = f.substring(d), d = f.search("douche"), 0 < d)) {
        for (console.log("Buttons find:"), f = b[c].getElementsByClassName("align-center align-middle spacer-small-left spacer-small-right")[0].getElementsByTagName("button"), !0 === $(f).hasClass("disabled") && (f = b[c].getElementsByClassName("align-center align-middle spacer-small-left spacer-small-right")[1].getElementsByTagName("button"), a = 1), console.log(f), d = 0; d < f.length; d++) {
          var g = b[c].getElementsByClassName("align-center align-middle spacer-small-left spacer-small-right")[0].getElementsByClassName("disabled button button-style-8");
          if (void 0 === g[a] || null === g[0]) {
...
$(".lw_gui").append('<span class="lw">\u0412\u044b\u0431\u0438\u0440\u0430\u0442\u044c \u041a\u0421\u041a \u0438\u0437: </span> <select id="ksk_select" name="ksk_select">\t<option value="all">\u041e\u0431\u0449\u0438\u0445</option>\t<option value="reserve">\u0420\u0435\u0437\u0435\u0440\u0432</option>\t</select><br>');
...
$(".lw_gui").append('<br><span class="lw">\u041a\u043e\u043b\u0438\u0447\u0435\u0441\u0442\u0432\u043e \u0441\u043e\u0440\u0438\u043a\u043e\u0432:</span><input type="text" size="6" id="sorik" /><br>');
...
function save_settings() {
  var a = $("#lw_zavod").val(), b = $("#train1").val(), c = $("#train2").val(), f = $("#train3").val(), d = $("#walk1").val(), g = $("#walk2").val(), h = $("#specialisation").val(), k = $("#ksk_r").val(), l = $("#ksk_select").val(), e = $("#compName").val(), m = $("#compName2").val(), n = $("#offerstobedone").val(), p = $("#sorik").val(), q = $("#name_male").val(), r = $("#name_female").val(), t = $("#poroda").val(), u = $("#speed").val();
  ...
  localStorage.setItem("lwm_walk1", d);
  localStorage.setItem("lwm_walk2", g);
  localStorage.setItem("lwm_spec", h);
  localStorage.setItem("lwm_ksk", k);
  localStorage.setItem("lwm_ksk_select", l);
  localStorage.setItem("lwm_comp", e);
  localStorage.setItem("lwm_comp2", m);
  localStorage.setItem("lwm_offers", n);
  localStorage.setItem("lwm_sorik", p);
  localStorage.setItem("lwm_name_male", q);
  localStorage.setItem("lwm_name_female", r);
  localStorage.setItem("lwm_poroda", t);
  localStorage.setItem("lwm_nav", nav);
  localStorage.setItem("lwm_speed", u);
...
function load_settings() {
  ...
  ksk_select = localStorage.getItem("lwm_ksk_select");
  ...
  sorik = localStorage.getItem("lwm_sorik");
...
function form_settings() {
  ...
  $("#ksk_select option[value='" + ksk_select + "']").attr("selected", "selected");
  ...
  function c() {
    if (700 > timeConvert()) {
      ...
      setTimeout(function() {
        ...
        localStorage.setItem("sorik2_count", parseInt(localStorage.getItem("sorik2_count"), 10) + 1);
      }, a);
      a += getRandomPause(longPause1, longPause2);
      setTimeout(c, a);
    } else {
